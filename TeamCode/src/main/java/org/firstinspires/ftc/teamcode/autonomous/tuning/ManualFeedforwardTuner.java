...
/*
TLDR:
1. Run ManualFeedforwardTuner via RC
2. Connect to RC Wifi
3. Navigate to 192.168.43.1:8080/dash
4. Run the OpMode (graph wont show up until you start it)
5. In dashboard, look for DriveConstants, click and dropdown appears. Look for kA, kV, and kStatic
6. In ManualFeedforwardTuner dropdown, DISTANCE should be big enough that targetVelocity line has plateau.
Series of triangles- > increase DISTANCE
