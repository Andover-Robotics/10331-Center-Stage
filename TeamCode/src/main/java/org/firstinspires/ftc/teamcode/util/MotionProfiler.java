...
public class MotionProfiler {
    ...
    //isOver is only false when the motion profile has been created and is not initialized.
    ...
    public void init(double start_pos, double final_pos){
        ...
        acceleration_distance = 0.5 * temp_max_a * Math.pow(acceleration_dt,2);
...
//        Return the current reference position based on the given motion profile times, maximum acceleration, velocity, and current time.
        ...
        // if we're decelerating
            ...
            return start_pos + acceleration_distance + cruise_distance + new_max_velocity * decel_time - 0.5 * temp_max_a * Math.pow(decel_time,2);
        }
    }
