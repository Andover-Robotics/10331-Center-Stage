...
/*
Run the MaxAngularVelocityTuner opmode.
It will spin in a circle at maximum speed for the specified number of seconds.
After it has completed its sequence, it will print a "Max Angular Velocity" value.
Set the MAX_ANG_VEL field in your DriveConstants.java file to this value.
 */
